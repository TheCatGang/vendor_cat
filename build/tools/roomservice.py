...
DEBUG = False
default_manifest = ".repo/manifests/cat_default.xml"
custom_local_manifest = ".repo/local_manifests/cat_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "cat.dependencies"
org_manifest = "CAT-Devices"  # leave empty if org is provided in manifest
org_display = "CAT-Devices"  # needed for displaying
